            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Text('Change', style:Theme.of(context).textTheme
              ...
              Row(
                children: [
                  ...
                  Text('${address?.pincode}' ,style: Theme.of(context).textTheme.titleSmall?.copyWith(fontWeight: FontWeight.bold)),
                ],
              ),
              Row(
                children: [
